...
pre_calculated_nodes_path = "C:/Androniki/pythonProject1/outputs/cool_place_nodes.pkl"
...
def load_cool_place_polygons(polygon_path):
    # Load polygons representing cool places
...
def calculate_and_save_cool_place_nodes(graph, cool_place_polygons, output_path):
    ...
    def is_within_polygon(node_geometry):
        # Find nodes within the bounds of each cool place polygon
    ...
    # Apply spatial check to each node and store the indices of cool place nodes
